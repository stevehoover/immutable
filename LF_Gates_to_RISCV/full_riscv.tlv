...
\SV
   ...
   m4_include_url(['https://raw.githubusercontent.com/shivampotdar/LF-Build-a-RISC-V-Workshop/main/tlv_lib/risc-v_shell_lib.tlv?token=AHW2IGLCSWUOH7YSH5BIMITABYTOM'])
...
\TLV
   ...
   |cpu
      ...
      @0
         $reset = *reset;
         $pc[31:0] = $reset       ? '0              :
                     >>1$taken_br ? >>1$br_tgt_pc   :  //9
                     >>1$is_jal   ? >>1$br_tgt_pc   :  // 13
                     >>1$is_jalr  ? >>1$jalr_tgt_pc :  // 13
                                    >>1$inc_pc ;
